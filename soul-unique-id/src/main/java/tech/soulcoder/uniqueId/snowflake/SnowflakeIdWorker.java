package tech.soulcoder.uniqueId.snowflake;

import java.text.SimpleDateFormat;
import java.util.Date;

import tech.soulcoder.uniqueId.SystemClock;
...
public class SnowflakeIdWorker {
    ...
    private final static String MSG_UID_PARSE
        = "{\"UID\":\"%s\",\"timestamp\":\"%s\",\"workerId\":\"%d\",\"dataCenterId\":\"%d\",\"sequence\":\"%d\"}";
    ...
    /**
     * 默认采用系统  System.currentTimeMillis()
     */
